          ...
          <div key={seller.id} className="seller-card">
            ...
            <div className="seller-header">
              <Image
                ...
                style={{ borderRadius: "50px", marginTop: ".9rem", marginLeft: "1rem" }}
              />

              <h2 className="seller-name" style={{ fontSize: "1.2rem", marginBottom: ".5rem", marginLeft: "1rem" }}>
                {seller.name}
              </h2>

              <p style={{ marginLeft: "1rem", marginBottom: "1rem", fontSize: "1rem" }}>
